...
#include <string.h>
/*
#define CONFIG_CS_GPIO    5 //18 //5  //15
#define CONFIG_RST_GPIO   26 // 26 //21 //26 //32
#define CONFIG_MISO_GPIO  19 // 13 //19 //13
#define CONFIG_MOSI_GPIO  23 // 23 //27 //23 //12
#define CONFIG_SCK_GPIO   18 // 18 //5 //18 //14
*/
/*
#define CONFIG_CS_GPIO    18 //heltec lora
#define CONFIG_RST_GPIO   14
#define CONFIG_MISO_GPIO  19
#define CONFIG_MOSI_GPIO  27
#define CONFIG_SCK_GPIO   5
*/
#define CONFIG_CS_GPIO    18 //wroom board lora
#define CONFIG_RST_GPIO   14
#define CONFIG_MISO_GPIO  19
#define CONFIG_MOSI_GPIO  27
#define CONFIG_SCK_GPIO   5
/*
#define CONFIG_CS_GPIO    22 //18 //heltec kit
#define CONFIG_RST_GPIO   14
#define CONFIG_MISO_GPIO  19
#define CONFIG_MOSI_GPIO  27
#define CONFIG_SCK_GPIO   5
